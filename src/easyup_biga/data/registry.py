...
DATASETS: tuple[DatasetDefinition, ...] = (
    ...
    DatasetDefinition(
        ...
        dataset_id="cn.equity.daily_bars",
        title="A 股全市场未复权 EOD 日线",
        schema_version=1,
        primary_provider="eastmoney-eod",
        fallback_providers=(), validation_providers=(),
        partition_keys=("trade_date",), storage_policy="parquet",
        quality_policy="cn-equity-eod-v1", raw_table="raw_artifacts",
        consumers=("easyup_biga.data.analytics:query_eod_between",),
    ),
    DatasetDefinition(
        dataset_id="cn.security.tradability",
        title="A 股逐日可交易状态",
        schema_version=1,
        primary_provider="derived-biga",
        fallback_providers=(), validation_providers=(),
        partition_keys=("trade_date",), storage_policy="parquet",
    ...
    DatasetDefinition(
        ...
        schema_version=1,
        primary_provider="csv-adjustment",
        fallback_providers=(), validation_providers=(),
        partition_keys=("trade_date",), storage_policy="parquet",
